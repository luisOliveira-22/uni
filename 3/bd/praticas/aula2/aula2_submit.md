...
> Entidades:
	- Empresa
	- Produtos (atributos: código, preço, nome, taxa IVA)
	- Armazém
	- Encomenda (atributos: número, data)
	- Fornecedor (atributos: NIF, email, nome)
	- Tipo de Fornecedor (atributos: código, designação)
	- Condições de pagamento (atributos: código, designação)

> Relações:
	- Empresa -> comercializa -> Empresa
	- Produtos -> estão -> Armazém
	- Encomenda -> itens -> Produto
	- Fornecedor -> tem -> Encomenda
	- Fornecedor -> tem -> Tipo de Fornecedor
	- Fornecedor -> tem -> Condições pagamento
...
- Empresa -> comercializa -> Empresa
	- Relação 1:N
	- Relação binária
	- Empresa tem obrigatoriedade

- Produtos -> estão -> Armazém
	- Relação N:1
	- Relação binária
	- Produtos tem obrigatoriedade

- Encomenda -> itens -> Produto
	- Relação M:N
	- Relação binária
	- Encomenda tem obrigatoriedade
...
![ex_2_4a](ex_2_4a.png "Exercício 4")
